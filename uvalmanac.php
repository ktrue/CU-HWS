...
<path fill="<?php if($weather["uvdmax"]>0){echo " rgba(115, 141, 38, 1.000)";} else echo "currentcolor"?>"  opacity="1.00" d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
 ...
 <br>
<div class="hitempy">  
  <?php if ($weather["uvdmax"] < $weather["uvydmax"]){echo "Max <orange>UVI</sup></orange> <green>Today</green> Recorded is <green>Less</green> than Yesterday"; echo " ",$weather["uvydmax"] - $weather["uvdmax"], " <orange>UVI</sup></orange> Less <green>".$fallingsymbol."</green>";}  
  else if ($weather["uvdmax"] > $weather["uvydmax"]){echo "Max <orange>UVI</sup> <green>Today</green> Recorded <orange>Higher</orange> than Yesterday";echo " ",$weather["uvdmax"] - $weather["uvydmax"], " <orange>UVI</sup> ".$risingsymbol."</orange>";}
  ?></span>
            </div> 
