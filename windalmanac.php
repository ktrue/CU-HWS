...
actual{font-size:13px;float:right;position:absolute;left:125px;top:20px;-webkit-border-radius:4px;-moz-border-radius:4px;-o-border-radius:4px;border-radius:4px;background:rgba(61, 64, 66, 1.000);padding:5px;}.uvmaxi3{position:absolute;left:-30px;color:rgba(0, 154, 171, 1.000);margin-top:-40px;font-size:16px;width:240px;}.uvmaxi3 span{color:#aaa}sup{font-size:13px;}.higust{color:#aaa;font-size:12px;}.higust span{color:rgba(255, 124, 57, 1.000)}
windgusts{position:absolute;font-size:15px;margin-top:20px;left:70px;color:#444}.hitempy{background:rgba(61, 64, 66, 0.8);color:#aaa;font-size:12px;width:180px;padding:3px;border-radius:4px;margin-top:0;margin-left:10px;}
...
<section class="weather34cards">
   <div class="weather34card weather34card--earthquake1">
            ...
            <div class="weather34card_weather34-wrapper"><span class="weather34card__count-text--big">
              <?php
	// UV INDEX
	if ($weather["winddmax"]>80)  {
	echo "<red>",$weather["winddmax"] . "</value>";} 	
	else if ($weather["winddmax"]>20)  {
	echo "<orange>",$weather["winddmax"] . "</value>";} 		
	else if ($weather["winddmax"]>=0) {
	echo "<green>",$weather["winddmax"] . "</value>";}		
	echo "<sup><unit>",$weather["wind_units"]," </span>"
?>
...
<path fill="<?php if($weather["winddmax"]>0){echo " #9aba2f";} else echo "currentcolor"?>"   opacity="0.7"  d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
 ...
 <br>
<div class="hitempy">  
  <?php if ($weather["winddmax"] < $weather["windydmax"]){echo "Max Gust <green>Today</green> Recorded was <blue>Less</blue> than Yesterday"; echo " <br><b> ",$weather["windydmax"] - $weather["winddmax"], " ",$weather["wind_units"]," </b><blue>Less ".$fallingsymbol."</blue>";}  
  else if ($weather["winddmax"] > $weather["windydmax"]){echo "Max Gust <green>Today</green> Recorded was <orange>Higher</orange> than Yesterday";echo "<br> <b>",$weather["winddmax"] - $weather["windydmax"], " ",$weather["wind_units"]," </b><orange> More ".$risingsymbol."</orange>";}
  ?></span>
            </div> 
...
<path fill="<?php if($weather["windmmax"]>0){echo " #9aba2f";} else echo "currentcolor"?>"   opacity="0.7"  d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
              ...
              <?php
	//month	
	if ($weather["windmmax"]>80)  {
	echo "<red>",$weather["windmmax"] . "</value>";} 	
	else if ($weather["windmmax"]>30)  {
	echo "<orange>",$weather["windmmax"] . "</value>";} 	
	else if ($weather["windmmax"]>=0) {
	echo "<green>",$weather["windmmax"] . "</value>";}	
	echo "<sup><unit>",$weather["wind_units"]," </span>"	
?>
...
<br>
<img src="css/icons/gust.svg" width="40px" > <windgusts> WIND GUSTS</windgusts>
...
<path fill="<?php if($weather["windydmax"]>0){echo " #9aba2f";} else echo "currentcolor"?>"   opacity="0.7"  d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
	...
	if ($weather["windydmax"]>80)  {
	echo "<red>",$weather["windydmax"] . "</value>";}	
	else if ($weather["windydmax"]>30)  {
	echo "<orange>",$weather["windydmax"] . "</value>";} 	
	else if ($weather["windydmax"]>0) {
	echo "<green>",$weather["windydmax"] . "</value>";}	
	echo "<sup><unit>",$weather["wind_units"]," </span>"
...
<br>
<img src="css/icons/gust.svg" width="40px" > <windgusts> WIND GUSTS</windgusts> <windgusts> WIND GUSTS</windgusts>
...
<path fill="<?php if($weather["windymax"]>0){echo " #9aba2f";} else echo "currentcolor"?>"   opacity="0.7"  d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
	...
	if ($weather["windymax"]>80)  {
	echo "<red>",$weather["windymax"] . "</value>";} 		
	else if ($weather["windymax"]>20)  {
	echo "<orange>",$weather["windymax"] . "</value>";} 	
	else if ($weather["windymax"]>=0) {
	echo "<green>",$weather["windymax"] . "</value>";}	
	echo "<sup><unit>",$weather["wind_units"]," </span>"	
?>
