...
include_once('livedata.php');include('weatherflow.php');?>
...
?>
 ...
 <div class="weather34luxword">Brightness</div>
	...
	if ($weather["lux"]==0){ echo "<div class=circlelux>".$nosun."</div>";}
	else if ($weather["lux"]>99999) {echo "<div class=circlelux><span>Lux</span>".number_format($weather["lux"]/1000,0). "K";}	
	else echo "<div class=circlelux><span>Lux</span>".$weather["lux"];?> 
</span>
</div></div></div>
