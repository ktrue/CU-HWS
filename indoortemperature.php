...
<?php //chuck
if($weather["temp_units"]=='F' &&  anyToC($weather["temp_indoor"])>30){echo "<div class=tempconvertercirclered>".anyToC($weather["temp_indoor"])."&deg;<smalltempunit2>C" ;}
else if($weather["temp_units"]=='F' &&  anyToC($weather["temp_indoor"])>25){echo "<div class=tempconvertercircleorange>".anyToC($weather["temp_indoor"])."&deg;<smalltempunit2>C" ;}
...
else if( $weather["temp_units"]=='C' &&  anyToC($weather["temp_indoor"])>30){echo "<div class=tempconvertercirclered>".anyToF($weather["temp_indoor"])."&deg;<smalltempunit2>F" ;}
else if( $weather["temp_units"]=='C' &&  anyToC($weather["temp_indoor"])>25){echo "<div class=tempconvertercirclerange>".anyToF($weather["temp_indoor"])."&deg;<smalltempunit2>F" ;}
...
<svg id="weather34 indoor house" width="128pt" height="118pt" viewBox="0 0 475 497" version="30092018" fill="currentcolor">
