...
indoorblue1,indoorgreen1,indoororange1,indoorred1,indooryellow1{font-family:weathertext,helvetica,arial;padding:5px;}
.indoortrendhouse1{position:absolute;margin-left:195px;margin-top:25px}
.indoorhomesvg1{margin-top:-22px;left:20px;color:rgba(53,56,58,1);margin-left:38px}




.weather34indoorword{margin-left:127px;margin-top:42px}
.indoortrendhouse1{position:absolute;margin-left:142px;margin-top:50px;font-size:0.65rem;z-index:1;color:#fff}
.indoorhomevalue1{position:relative;margin-top:-89px;left:0;font-size:23px;padding-right:4px;padding-left:0}


.indoorhomesvg2{margin-top:-22px;left:53px;color:rgba(53,56,58,1);margin-left:-40px}
.indoortrendhouse2{position:absolute;margin-left:195px;margin-top:25px}
.indoorhomevalue2{position:relative;margin-top:-79px;left:0;font-size:23px;padding-right:4px;padding-left:0}



indoorblue1,indoorgreen1,indoororange1,indoorred1,indooryellow1{font-family:'weathertext',Arial,Helvetica,system;width:5.5rem;height:5.05rem;font-size:2.2rem;padding-top:10px;color:#fff;background:rgba(59, 156, 172, 1.000);border-bottom: 10px solid rgba(56, 56, 60, 1);display:flex;align-items:center;justify-content:center;-webkit-border-radius: 3px;-moz-border-radius: 3px;-o-border-radius: 3px;border-radius: 3px;position:absolute;margin-left:90px;top:-25px}
indoorred1{background:rgba(211,93,78,1)}indoororange1{background:#ff8841}indoorgreen1{background:#9aba2f}indoorblue1{background:#01a4b4}indooryellow1{background:rgba(233,171,74,1)}


smallrainunit{font-size:.7em}
.tempconvertercircleblue,.tempconvertercirclegreen.tempconvertercirclegreen,.tempconvertercirclered,.tempconvertercircleyellow,.tempconvertercircleorange{background:rgba(144, 177, 42, 0.8);display:flex;align-items:center;justify-content:center;height:1.8rem;width:5rem;border:2px solid rgba(56, 56, 60, 1);overflow:hidden;border-radius:4px;color:#fff;line-height:16px;font-family:'weathertext',Arial,Helvetica,system;font-size:1em}.tempconvertercircleyellow{background:rgba(230, 161, 65, 0.8)}.tempconvertercircleorange{background:rgba(255, 124, 57, 0.8)}.tempconvertercirclered{background:rgba(211, 93, 78, 0.8)}
.tempconvertercircleblue{background:rgba(59,156,172,0.6)}.tempconvertercirclegreen{background:rgba(144,177,42,1)}
.tempindoorconverter{position:absolute;margin-left:230px;margin-top:20px;font-size:12px}smallsup{color:#aaa;font-size:0.5rem;font-family:Arial, Helvetica, system}.tempconverter1{position:absolute;margin-left:55px;margin-top:0;font-size:12px}
</style>
</head>
<body>
