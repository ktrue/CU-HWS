...
// modified for languages - ktrue - 30-Jan-2019
...
if ($weather["cloudbase3"]>=1500){
	echo "<div class=cloudbase1500>";
} else {
	echo "<div class=cloudbase0>";
}

if($weather["temp_units"] == 'F') {
	echo $weather["cloudbase3"]."&nbsp; ft<br>"; 
	echo round($weather["cloudbase3"]*0.3048,0)."&nbsp; m";  
} else {
	echo round($weather["cloudbase3"]*0.3048,0)."&nbsp; m<br>";  
	echo $weather["cloudbase3"]."&nbsp; ft"; 
}
...
<?php //WEATHER34 AIR QAULITY SVG
if ($aqiweather["aqi"]>300){echo "<div class=\"air300\"><img src=\"css/aqi/hazair.svg?ver=1.4\" width=\"110\" height=\"100\" alt=\"weather34 hazardous air quality\" title=\"weather34 hazardous air quality\" "; }
else if ($aqiweather["aqi"]>200){echo "<div class=\"air200\"><img src=\"css/aqi/vhair.svg?ver=1.4\" width=\"110\" height=\"100\" alt=\"weather34 very unhealthy air quality\" title=\"weather34 very unhealthy air quality\"" ; }
else if ($aqiweather["aqi"]>150){echo "<div class=\"air150\"><img src=\"css/aqi/uhair.svg?ver=1.4\" width=\"110\" height=\"100\" alt=\"weather34 unhealthy air quality\" title=\"weather34 unhealthy air quality\"" ; }
else if ($aqiweather["aqi"]>100){echo "<div class=\"air100\"><img src=\"css/aqi/uhfsair.svg?ver=1.4\" width=\"110\" height=\"100\"  alt=\"weather34 unhealthy for some air quality\" title=\"weather34 unhealthy for some air quality\"" ; }
else if ($aqiweather["aqi"]>50){echo "<div class=\"air50\"><img src=\"css/aqi/modair.svg?ver=1.4\" width=\"110\" height=\"100\" alt=\"weather34 moderate air quality\" title=\"weather34 moderate air quality\"" ; }
else if ($aqiweather["aqi"]>=0){echo "<div class=\"air0\"><img src=\"css/aqi/goodair.svg?ver=1.4\" width=\"110\" height=\"100\" alt=\"weather34 good air quality\" title=\"weather34 good air quality\"" ; }
...
<div class="icon"><img src="img/purpleair.svg" width="30" alt="https://purpleair.com/" title="https://purpleair.com/"></div></div></div></div></div>
</section>
<div class="provided">   
&nbsp;
